/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 6b1873d2e47b8ed2950342822b35744f)
// Runtime types generated with workerd@1.20260111.0 2025-12-12 nodejs_als,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		pexisgle_dev_kv: KVNamespace;
